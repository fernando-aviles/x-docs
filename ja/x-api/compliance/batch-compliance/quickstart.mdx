...
このガイドでは、投稿またはユーザーのコンプライアンス状況を確認するためのバッチコンプライアンスジョブの作成手順を説明します。
...
<AccordionGroup>
  <Accordion title="投稿のコンプライアンスイベント">
    | アクション | 理由 | 説明 |
    |:-------|:-------|:------------|
    | `delete` | `deleted` | 投稿が削除された |
    | `delete` | `bounced` | 投稿がコンプライアンスチェックに失敗した |
