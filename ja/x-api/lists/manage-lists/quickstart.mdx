...
keywords: ["リスト管理 クイックスタート", "リスト作成チュートリアル", "リスト管理ガイド"]
---

import { Button } from '/snippets/ja/button.mdx';

このガイドでは、List の作成、更新、削除の方法を順を追って説明します。
...
<Steps>
  <Step title="リクエストを準備する">
    リストの名前（必須）と、必要に応じて説明とプライバシー設定を指定します。
...
<CardGroup cols={2}>
  ...
  <Card title="リスト検索" icon="magnifying-glass" href="/ja/x-api/lists/list-lookup/quickstart">
    リストの詳細を取得
  </Card>
