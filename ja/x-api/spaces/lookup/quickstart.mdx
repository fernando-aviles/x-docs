...
description: ID または作成者を使って Space の詳細を取得する
keywords: ["Spaces クイックスタート", "Space ルックアップチュートリアル", "Spaces ガイド"]
---

import { Button } from '/snippets/ja/button.mdx';

このガイドでは、Spaces lookup エンドポイントを使用して Space の情報を取得する方法を説明します。
