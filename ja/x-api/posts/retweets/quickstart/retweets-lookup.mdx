...
keywords: ["リツイート検索", "リツイートクイックスタート", "リツイートを取得", "リツイートチュートリアル", "リツイートガイド", "リツイート例"]
---

import { Button } from '/snippets/ja/button.mdx';

このガイドでは、特定の投稿をリポストしたユーザーを取得する方法を説明します。
...
<Steps>
  ...
  <Step title="リクエストを送信する">
    <CodeGroup dropdown>
      ...
      # ページネーションを使って投稿をリツイートしたユーザーを取得する
...
<CodeGroup dropdown>
  ...
  # expansions を指定してリツイートしたユーザーを取得
  for page in client.posts.get_retweeted_by(
      "1354143047324299264",
