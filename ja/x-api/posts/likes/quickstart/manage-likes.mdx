...
description: X API を使用して投稿にいいねしたり、いいねを解除したりする
keywords: ["いいね管理", "投稿にいいねする", "いいね解除", "いいね クイックスタート", "いいね チュートリアル", "いいね ガイド"]
---

import { Button } from '/snippets/ja/button.mdx';

このガイドでは、X API を使用して投稿に「いいね」を付けたり、取り消したりする方法を説明します。
...
<Steps>
  <Step title="自分のユーザーIDを取得する">
    認証済みユーザーのユーザーIDが必要です。これは [user lookup endpoint](/ja/x-api/users/lookup/introduction) を使うか、Access Token から確認できます（数値の部分があなたのユーザーIDです）。
  </Step>
