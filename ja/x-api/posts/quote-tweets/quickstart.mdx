...
keywords: ["引用投稿 クイックスタート", "引用投稿 チュートリアル", "引用投稿取得ガイド"]
---
...
<Steps>
  <Step title="投稿 ID を見つける" icon="message">
    引用投稿を取得したい投稿の ID を取得します。投稿の URL から確認できます。
  ...
  <Step title="結果をページングする" icon="arrow-right">
    SDK はページネーションを自動的に処理します。cURL を使う場合は、`next_token` を使用してさらに引用投稿を取得します。
