...
description: 数分で初めてのポスト取得リクエストを実行できるようになります
keywords: ["ポスト取得クイックスタート", "ツイート検索クイックスタート", "取得チュートリアル", "取得ガイド", "ツイート取得クイックスタート", "取得の例"]
---
...
<Steps>
  <Step title="ポストIDを取得する">
    すべてのポストには一意のIDがあります。ポストのURLに含まれています。
  ...
  <Step title="追加フィールドをリクエストする">
    ...
    <CodeGroup dropdown>
      ...
      # 追加のフィールドとexpansionsを指定してポストを取得します
