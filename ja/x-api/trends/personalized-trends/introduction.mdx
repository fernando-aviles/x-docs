...
sidebarTitle: はじめに
description: 認証済みユーザー向けのパーソナライズされたトレンドトピックを取得します
keywords: ["パーソナライズされたトレンド", "トレンド API", "トレンドトピック", "ユーザートレンド", "For You トレンド"]
---

import { Button } from '/snippets/ja/button.mdx';

Personalized Trends エンドポイントは、認証済みユーザーの位置情報や興味・関心に基づき、そのユーザー向けにパーソナライズされたトレンドトピックを返します。
...
<Note>
  ...
  * [OAuth 2.0 PKCE](/ja/resources/fundamentals/authentication#oauth-2-0-authorization-code-flow-with-pkce-2) によるユーザーアクセストークン
</Note>
