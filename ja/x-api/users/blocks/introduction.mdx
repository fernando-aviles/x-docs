...
title: ブロック
sidebarTitle: 概要
description: ユーザーをブロックおよびブロック解除し、ブロックしたユーザーの一覧を取得する
keywords: ["ブロック", "ユーザーをブロック", "ブロック解除", "ブロック済みユーザー", "ブロック API"]
---

import { Button } from '/snippets/ja/button.mdx';

Blocks エンドポイントでは、ユーザーのブロックおよびブロック解除を行い、認証済みユーザーがブロックしているユーザーのリストを取得できます。
