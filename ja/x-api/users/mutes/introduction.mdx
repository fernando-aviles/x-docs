...
title: ミュート
sidebarTitle: はじめに
description: ユーザーをミュートおよびミュート解除し、ミュート中のユーザーの一覧を取得します
keywords: ["ミュート", "ユーザーをミュート", "ミュート解除", "ミュート済みユーザー", "ミュート API"]
---

import { Button } from '/snippets/ja/button.mdx';

Mutes エンドポイントを使用すると、ユーザーのミュートおよびミュート解除を行い、認証ユーザーがミュートしているユーザーのリストを取得できます。
...
| Method | Endpoint | 説明 |
|:-------|:---------|:------------|
| GET | [`/2/users/:id/muting`](/ja/x-api/users/get-muting) | ミュートしているユーザーを取得 |
