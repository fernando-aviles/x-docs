...
<Steps>
  <Step title="自分のユーザーIDを取得する">
    認証済みユーザーのユーザーIDが必要です。[ユーザー照会エンドポイント](/ja/x-api/users/lookup/introduction)を使用するか、Access Token から確認できます（数値の部分が自身のユーザーIDです）。
  </Step>

  <Step title="ミュート対象のユーザーIDを取得する">
    ミュートしたいアカウントのユーザーIDを、[ユーザー照会エンドポイント](/ja/x-api/users/lookup/introduction)を使って取得します。
  </Step>
