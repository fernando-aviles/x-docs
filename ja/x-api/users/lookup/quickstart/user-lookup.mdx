---
title: ユーザー取得クイックスタート
sidebarTitle: ユーザー取得
description: ID またはユーザー名でユーザーを取得します
keywords: ["ユーザー取得クイックスタート", "ユーザー取得チュートリアル", "ID でユーザーを取得するガイド", "ユーザー名でユーザーを取得するガイド"]
---

import { Button } from '/snippets/ja/button.mdx';

このガイドでは、ユーザーをIDまたはユーザー名で検索する手順を説明します。
...
<Note>
  ...
  * 承認されたAppを持つ[開発者アカウント](https://developer.x.com/en/portal/petition/essential/basic-info)
  * App の Bearer Token
</Note>
...
保護されたユーザーのdataは引き続き返却されますが、そのユーザーをフォローしていない限り、そのユーザーの投稿にはアクセスできません。
