...
| [annotations](/ja/x-api/fundamentals/post-annotations) フィールド（固定投稿上）をサポート |     | ✔   |
| 新しい [metrics](/ja/x-api/fundamentals/metrics) フィールド（固定投稿上）のリクエストをサポート |     | ✔   |
| [conversation&#95;id](/ja/x-api/fundamentals/conversation-id) フィールド（固定投稿上）をサポート |     | ✔   |
