...
User Search エンドポイントを使用すると、キーワードでユーザーを検索できます。名前、ユーザー名、または自己紹介文の内容に基づいてユーザーを見つけることができます。
...
| メソッド | エンドポイント | 説明 |
|:-------|:---------|:------------|
| GET | [`/2/users/search`](/ja/x-api/users/search-users) | ユーザー検索 |
  ...
  "data": [
    {
      ...
      "username": "pythondev",
      "description": "Pythonでクールなものを作っています",
      "verified": false,
      "public_metrics": {
