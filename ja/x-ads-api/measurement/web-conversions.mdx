...
<AccordionGroup>
  ...
  <Accordion title="コンバージョンタグのデフォルトのアトリビューションウィンドウ設定はどうなっていますか？">
    デフォルトの投稿ビュー・アトリビューションウィンドウ: 1 日間

    デフォルトの投稿エンゲージメント・アトリビューションウィンドウ: 14 日間

    これらのデフォルト値は、コンバージョンタグの設定時やタグ作成後いつでも変更できます。投稿エンゲージメント・アトリビューションウィンドウの選択肢は 1、7、14、30、60、90 日です。投稿ビュー・アトリビューションウィンドウの選択肢は「なし」、1、7、14、30、60、90 日です。
  </Accordion>
