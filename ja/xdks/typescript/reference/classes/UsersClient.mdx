...
自分の投稿がリポストされた投稿を取得\
認証済みユーザーの投稿をリポストしている投稿の一覧を取得します。
...
投稿のいいねを取り消す\
認証済みユーザーが、指定されたIDの投稿に対するいいねを取り消します。
...
| `tweetId` | `string` | ユーザーがいいねを取り消そうとしている投稿のID。 |
| `options` | `Object` | - |
...
投稿のリポストを取り消す\
認証済みユーザーが、指定した ID の投稿のリポストを取り消します。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `id` | `string` | 投稿のリポストを要求している認証済みの発信元ユーザーのID。 |
...
ブックマークを削除
認証済みユーザーのブックマークから、IDで指定した投稿を削除します。
...
投稿に「いいね」する\
認証済みユーザーが、特定の ID の投稿に「いいね」します。

#### パラメーター

| Name | Type | Description |
| :------ | :------ | :------ |
| `id` | `string` | 投稿への「いいね」をリクエストしている認証済みソースユーザーのID。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `id` | `string` | 投稿のリポストを要求している、認証済み送信元ユーザーのID。 |
