...
このモジュールは、安全な認可フローのための OAuth1.0a 認証機能を提供します。リクエストトークンの生成、認可 URL の生成、アクセストークンの交換、OAuth1 シグネチャの生成を含みます。
...
リクエストボディ（フォームエンコードされた文字列または空文字列）。
</ParamField>
