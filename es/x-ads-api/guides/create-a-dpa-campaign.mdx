...
Llama a la API GET accounts/:account&#95;id/funding&#95;instruments usando el id de la cuenta obtenido en el comando anterior.
...
* catalog&#95;id y product&#95;set&#95;id se encuentran en tu administrador de compras
...
* Después de este paso, la campaña estará disponible en el Administrador de anuncios de X.
...
* La URL debe comenzar con https://twitter.com; se pueden añadir parámetros UTM adicionales después, como en el siguiente ejemplo:
...
* Parámetros obligatorios: ID de cuenta de anuncios, ID de usuario, URI de card (del Paso 3), text, nombre y anuncio de producto dinámico
...
Si los anunciantes quieren ver la tarjeta en la interfaz de usuario (UI), también estará disponible.
