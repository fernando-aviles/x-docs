...
Esta guía te muestra cómo obtener los eventos de Mensajes Directos del usuario autenticado.
...
Obtén todos los eventos de MD del usuario autenticado:
...
Recupera los eventos de MD de una conversación uno a uno específica:
...
<CodeGroup dropdown>
  ...
  # Obtener eventos de MD de una conversación uno a uno
...
Recupera los eventos de MD de una conversación específica por ID:
...
<CodeGroup dropdown>
  ...
  # Obtén eventos de MD de una conversación por ID
...
Obtén únicamente eventos de tipos específicos:
...
<CodeGroup dropdown>
  ...
  # Obtener únicamente eventos MessageCreate
  for page in client.dm_events.list(
      event_types=["MessageCreate"],
      dm_event_fields=["created_at", "sender_id", "text"]
  ):
...
<CodeGroup dropdown>
  ...
  for page in client.dm_events.list(
      ...
      for event in page.data:
          # Vincular el remitente a partir de includes
...
| `pagination_token` | Token de la página siguiente |
