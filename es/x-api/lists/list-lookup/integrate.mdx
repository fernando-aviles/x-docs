...
| [OAuth 2.0 Authorization Code with PKCE](/es/resources/fundamentals/authentication#oauth-2-0-authorization-code-flow-with-pkce-2) | Aplicaciones para usuarios finales | Sí (propietarias/seguidas) |
| [OAuth 1.0a User Context](/es/resources/fundamentals/authentication) | Integraciones heredadas | Sí (propietarias/seguidas) |
...
| GET | [`/2/users/:id/owned_lists`](/es/x-api/users/get-owned-lists) | Obtener listas propiedad de un usuario |
...
<Accordion title="user.fields (requiere la expansión de owner_id)">
  | Campo | Descripción |
  |:------|:------------|
...
| 403 | Prohibido | La lista puede ser privada |
