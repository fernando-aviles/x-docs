...
Los endpoints de Manage Lists permiten crear, actualizar y eliminar listas en nombre de usuarios autenticados.
...
<CardGroup cols={2}>
  ...
  <Card title="Actualizar" icon="pen">
    Actualiza el nombre y la descripción de una Lista
  </Card>
