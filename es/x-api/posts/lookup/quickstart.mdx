...
description: Realiza tu primera solicitud de búsqueda de publicaciones en cuestión de minutos
keywords: ["inicio rápido de búsqueda de publicaciones", "inicio rápido de búsqueda de Tweets", "tutorial de búsqueda", "guía de búsqueda", "inicio rápido para obtener Tweets", "ejemplo de búsqueda"]
---
...
<Steps>
  ...
  <Step title="Solicita campos adicionales">
    ...
    <CodeGroup dropdown>
      ...
      # Obtén una Publicación con campos adicionales y expansions relacionadas
