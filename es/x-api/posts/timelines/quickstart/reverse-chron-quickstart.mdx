---
title: Guía rápida de la timeline de inicio
sidebarTitle: Timeline de inicio
description: Obtén la timeline de inicio de un usuario en orden cronológico inverso
keywords: ["timeline de inicio", "cronológico inverso", "guía rápida de la timeline de inicio", "guía rápida de la timeline", "tutorial de la timeline de inicio"]
---

import { Button } from '/snippets/es/button.mdx';

Esta guía te acompaña paso a paso para realizar tu primera solicitud al endpoint del timeline de inicio en orden cronológico inverso.
...
Necesitas el id de usuario de la cuenta para la que quieres recuperar la timeline de inicio. Encuéntralo usando el endpoint de búsqueda por nombre de usuario:
...
<div id="step-2-request-the-home-timeline">
  ## Paso 2: Solicitar la timeline de inicio
</div>

Realiza una solicitud GET con el id de usuario y el token de acceso de usuario:
...
<CodeGroup dropdown>
  ...
  # Obtener la timeline de inicio con paginación
...
<CodeGroup dropdown>
  ...
  # Obtener la home timeline con campos y expansions
...
Los SDK manejan la paginación automáticamente. Para cURL, usa el `next_token` de la respuesta para obtener más resultados:
...
<CardGroup cols={2}>
  <Card title="Menciones de usuario" icon="at" href="/es/x-api/posts/timelines/quickstart/user-mention-quickstart">
    Obtener publicaciones que mencionan a un usuario
  </Card>
