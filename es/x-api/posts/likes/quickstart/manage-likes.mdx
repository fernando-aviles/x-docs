...
description: Dar y quitar Me gusta a Publicaciones con la X API
keywords: ["gestionar me gusta", "dar me gusta en publicaciones", "quitar me gusta", "inicio rápido de me gusta", "tutorial de me gusta", "guía de me gusta"]
---
...
<Steps>
  <Step title="Obtén tu ID de usuario">
    Necesitas el ID del usuario autenticado. Puedes encontrarlo usando el [endpoint de búsqueda de usuario](/es/x-api/users/lookup/introduction) o a partir de tu token de acceso (la parte numérica es tu ID de usuario).
  </Step>
