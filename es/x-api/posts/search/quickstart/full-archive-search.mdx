---
title: Inicio rápido de búsqueda en el archivo completo
sidebarTitle: Búsqueda en el archivo completo
description: Busca en el archivo completo de Publicaciones desde 2006
keywords: ["búsqueda en el archivo completo", "inicio rápido de búsqueda en el archivo completo", "búsqueda histórica", "tutorial de archivo completo", "guía de búsqueda en archivo"]
---
...
<CodeGroup dropdown>
  ...
  # Búsqueda en todo el archivo con paginación
...
| Función | Búsqueda reciente | Búsqueda en el archivo completo |
|:--------|:--------------|:--------------------|
...
| Límite de solicitudes | 450 / 15 min | 300 / 15 min, 1 / seg |
