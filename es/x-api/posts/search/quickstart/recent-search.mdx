...
keywords: ["búsqueda reciente", "inicio rápido de búsqueda reciente", "tutorial de búsqueda reciente", "buscar Tweets", "guía de búsqueda reciente", "ejemplo de búsqueda"]
---
...
<Steps>
  ...
  <Step title="Realizar una solicitud" icon="terminal">
    <CodeGroup dropdown>
      ```bash cURL
  ...
  <Step title="Agregar campos y expansions" icon="sliders">
