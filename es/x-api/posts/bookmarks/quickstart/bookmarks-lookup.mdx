...
description: Recupera tus Publicaciones marcadas
keywords: ["inicio rápido de consulta de marcadores", "inicio rápido de consulta de marcador", "tutorial de consulta de marcador", "guía de consulta de marcador"]
---
...
<Steps>
  ...
  <Step title="Solicita tus marcadores">
    <CodeGroup dropdown>
      ...
      # Obtener publicaciones guardadas en marcadores con paginación
...
| `users.read` | Leer datos de usuario (para expansions) |
...
<CardGroup cols={2}>
  <Card title="Gestionar marcadores" icon="bookmark" href="/es/x-api/posts/bookmarks/quickstart/manage-bookmarks">
