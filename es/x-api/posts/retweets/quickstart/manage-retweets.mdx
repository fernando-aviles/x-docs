...
description: Retuitear y deshacer retuits con X API
keywords: ["gestionar retuits", "retuitear publicaciones", "quitar retuit", "inicio rápido sobre retuits", "tutorial de retuits", "guía de retuits"]
---

import { Button } from '/snippets/es/button.mdx';

Esta guía te explica cómo hacer Retuits y deshacer Retuits con la X API.
...
<Steps>
  ...
  <Step title="Envía la solicitud de retuit">
    <CodeGroup dropdown>
      ```bash cURL
...
<CardGroup cols={2}>
  <Card title="Búsqueda de Retweets" icon="retweet" href="/es/x-api/posts/retweets/quickstart/retweets-lookup">
    Obtén los usuarios que hicieron Retweet de una publicación
  </Card>
