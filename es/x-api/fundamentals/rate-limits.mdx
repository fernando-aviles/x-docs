...
| Method | Endpoint | Per App | Per User | Notas |
|:-------|:---------|:--------|:---------|:------|
...
Los clientes de Enterprise tienen límites de tasa personalizados. Póngase en contacto con su representante de cuenta o [solicite acceso a Enterprise](/es/enterprise/forms/enterprise-api-interest).
