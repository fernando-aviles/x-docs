...
description: Anotaciones de entidades y de contexto para el análisis semántico
keywords: ["anotaciones", "anotaciones de publicaciones", "anotaciones de entidad", "anotaciones de contexto", "NER", "reconocimiento de entidades nombradas", "temas"]
---
...
| `probability` | Nivel de confianza (0-1) |
| `type` | Tipo de entidad (Person, Place, etc.) |
| `normalized_text` | Nombre normalizado de la entidad |
