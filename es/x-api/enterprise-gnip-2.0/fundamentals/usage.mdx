---
title: API de uso
description: "La Usage API es una API REST gratuita que ofrece acceso programático y visibilidad del consumo de actividad en todos los productos de tu cuenta empresarial."
sidebarTitle: API de uso
keywords: ["Usage API", "API de uso empresarial", "seguimiento de uso", "seguimiento de consumo", "uso empresarial", "uso de API empresarial"]
---
