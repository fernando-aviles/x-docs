...
<Tabs>
  <Tab title="Bearer Token (solo App)">
  ...
  <Tab title="OAuth 2.0 (Contexto de usuario)">
    Para acciones en nombre de usuarios (publicar, seguir, etc.).
...
<CardGroup cols={2}>
  <Card title="Python SDK Docs" icon="book" href="/es/xdks/python/overview">
    Documentación completa del SDK de Python.
  </Card>

  <Card title="TypeScript SDK Docs" icon="book" href="/es/xdks/typescript/overview">
