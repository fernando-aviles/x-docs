...
description: Configura suscripciones al flujo de actividad para recibir eventos
keywords: ["guía rápida de actividad", "tutorial de flujo de actividad", "guía de suscripciones"]
---

import { Button } from '/snippets/es/button.mdx';

Esta guía te explica cómo configurar suscripciones al flujo de actividad para recibir eventos de actividad de cuentas en tiempo real.
...
| `favorite_events` | El usuario marca como favorita una Publicación |
...
<AccordionGroup>
  ...
  <Accordion title="Actualizar una suscripción">
    Actualiza los tipos de eventos de una suscripción:
