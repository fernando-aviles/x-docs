...
Esta guía te permitirá obtener información de Spaces mediante los endpoints de consulta de Spaces.
...
Amplía la información del usuario anfitrión:
...
| `is_ticketed` | Indica si el Espacio tiene entradas |
| `state` | Estado actual |
