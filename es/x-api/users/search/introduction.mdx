...
El endpoint de búsqueda de usuarios permite buscar usuarios por palabras clave. Encuentra usuarios por nombre, nombre de usuario o por el contenido de su biografía.
...
<CardGroup cols={2}>
  <Card title="Búsqueda por palabra clave" icon="magnifying-glass">
    Busca por nombre, usuario o biografía
  </Card>
