...
Esta guía te muestra cómo bloquear y desbloquear usuarios y cómo obtener tu lista de usuarios bloqueados.
...
<Note>
  ...
  * Una [cuenta de desarrollador](https://developer.x.com/en/portal/petition/essential/basic-info) con una aplicación (App) aprobada
...
<Steps>
  <Step title="Obtén tu ID de usuario">
    Necesitas el ID de tu usuario autenticado para recuperar tu lista de usuarios bloqueados. Puedes obtenerlo del endpoint `/2/users/me` o usar el ID de tus tokens.
  </Step>
...
<Steps>
  <Step title="Identificar al usuario objetivo">
...
<CardGroup cols={2}>
  ...
  <Card title="Seguir" icon="user-plus" href="/es/x-api/users/follows/introduction">
    Administra a quién sigues
  </Card>
