---
title: Inicio rápido de búsqueda de usuarios
sidebarTitle: Búsqueda de usuarios
description: Buscar usuarios por ID o nombre de usuario
keywords: ["inicio rápido de búsqueda de usuarios", "tutorial para obtener un usuario con GET", "guía para obtener usuario por ID", "guía para obtener usuario por nombre de usuario"]
---

import { Button } from '/snippets/es/button.mdx';

Esta guía te explica cómo buscar usuarios por su ID o nombre de usuario.
...
<CodeGroup dropdown>
  ...
  print(f"Usuario: {response.data.username}")
...
Los datos de los usuarios protegidos se siguen devolviendo, pero no podrás acceder a sus Publicaciones a menos que los sigas.
