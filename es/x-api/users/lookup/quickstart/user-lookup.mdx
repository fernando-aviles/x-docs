---
title: Guía de inicio rápido de búsqueda de usuarios
sidebarTitle: Búsqueda de usuarios
description: Busca usuarios por ID o nombre de usuario
keywords: ["guía de inicio rápido de búsqueda de usuarios", "tutorial para obtener usuarios", "guía de usuario por ID", "usuario por nombre de usuario"]
---

import { Button } from '/snippets/es/button.mdx';

Esta guía te muestra cómo buscar usuarios por su id o nombre de usuario.
...
| `public_metrics` | Recuento de seguidores y seguidos |
...
Los datos de los usuarios protegidos siguen devolviéndose, pero no podrás acceder a sus Publicaciones a menos que los sigas.
