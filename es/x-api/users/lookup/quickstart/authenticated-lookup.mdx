...
description: Obtén el perfil del usuario autenticado actualmente
keywords: ["usuario autenticado", "endpoint me", "usuario actual", "consulta autenticada"]
---
...
<CodeGroup dropdown>
  ...
  # La Publicación fijada se encuentra en response.includes.tweets
  ```
...
| `pinned_tweet_id` | Identificador de la Publicación fijada |
