...
keywords: ["migración de v1.1 a v2", "migración de seguimientos", "migrar seguimientos", "seguimientos de Standard a v2", "seguimientos de v1 a v2", "guía de migración"]
---
...
Además, en v2 los campos id y source&#95;user&#95;id no son obligatorios cuando se utilizan los endpoints estándar v1.1, ya que los tokens de acceso enviados con OAuth 1.0a User Context permitían inferir qué usuario estaba iniciando la acción de seguir/dejar de seguir.
