...
description: Gestiona seguimientos y obtén información sobre seguidores y seguidos
keywords: ["seguimientos", "seguidores", "seguidos", "API de seguimientos", "dejar de seguir", "búsqueda de seguidores"]
---

import { Button } from '/snippets/es/button.mdx';

Los endpoints de Follows te permiten seguir y dejar de seguir a usuarios, y obtener las listas de seguidores y de cuentas que sigue cualquier usuario.
...
<CardGroup cols={2}>
  <Card title="Seguir" icon="user-plus">
    Seguir a un usuario por cuenta del usuario autenticado
  </Card>
...
<CardGroup cols={2}>
  <Card title="Inicio rápido" icon="rocket" href="/es/x-api/users/follows/quickstart">
    Empieza a trabajar con follows
  </Card>
