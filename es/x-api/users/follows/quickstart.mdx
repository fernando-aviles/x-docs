...
description: Obtén las listas de seguidores y de cuentas que sigue un usuario, y gestiona los seguimientos
keywords: ["inicio rápido de seguimientos", "inicio rápido de seguidores", "tutorial de cuentas que sigues", "guía de seguimientos"]
---

import { Button } from '/snippets/es/button.mdx';

Esta guía explica cómo recuperar las listas de seguidores y seguidos, y cómo administrar los seguimientos.
...
<Note>
  ...
  * El User Access Token (para administrar los seguimientos)
</Note>
...
Obtén la lista de usuarios a los que sigue un usuario específico:
...
Sigue a un usuario en representación del usuario autenticado:
...
<CardGroup cols={2}>
  ...
  <Card title="Silencios" icon="volume-xmark" href="/es/x-api/users/mutes/introduction">
    Silencia y quita el silencio a usuarios
  </Card>
