...
description: Obtén listas de seguidores y de cuentas que sigues, y gestiona los seguimientos
keywords: ["inicio rápido seguimientos", "inicio rápido seguidores", "tutorial seguimientos", "guía de seguimientos"]
---

import { Button } from '/snippets/es/button.mdx';

Esta guía te explica cómo obtener las listas de seguidores y seguidos, y cómo gestionar seguimientos.
...
Obtén la lista de usuarios que sigue un usuario específico:
...
<Note>
  Si la cuenta de destino está protegida, `pending_follow` será `true` hasta que se apruebe la solicitud para seguirla.
</Note>
