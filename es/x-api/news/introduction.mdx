...
keywords: ["noticias", "API de noticias", "titulares", "últimas noticias", "búsqueda de noticias", "historias de noticias", "búsqueda de noticias"]
---

El endpoint de búsqueda de noticias permite a los desarrolladores obtener noticias y titulares de última hora en X.

Este endpoint admite autenticación mediante app-auth y user-auth con OAuth1 y OAuth2 PKCE.
