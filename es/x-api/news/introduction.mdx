...
El endpoint de búsqueda de noticias permite a los desarrolladores obtener noticias y titulares de última hora que están apareciendo en X.

Este endpoint admite autenticación mediante app-auth y user-auth para OAuth1 y OAuth2 PKCE.

<div id="getting-started">
  ## Primeros pasos
</div>

Para usar el endpoint, necesitas un [Bearer Token](/es/fundamentals/authentication/oauth-2-0/application-only) de la [Consola de Desarrollador](https://developer.x.com/en/portal/dashboard).
