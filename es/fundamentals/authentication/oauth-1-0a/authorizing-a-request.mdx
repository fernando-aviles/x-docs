...
keywords: ["autorizar una solicitud", "autorización OAuth", "autorización de solicitudes", "autorización OAuth 1.0a", "autorizar solicitud de API"]
---
...
El proceso para calcular oauth&#95;signature para esta solicitud se describe en [Crear una firma](/es/resources/fundamentals/authentication/oauth-1-0a/creating-a-signature).
...
Puedes generar un [access token](/es/resources/fundamentals/authentication/oauth-1-0a/obtaining-user-access-tokens) válido para tu cuenta en la página de configuración de tu [App de X](/es/resources/fundamentals/developer-apps) en la [Consola de desarrollador](/es/resources/fundamentals/developer-portal).
