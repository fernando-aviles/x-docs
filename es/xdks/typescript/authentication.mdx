...
<div id="bearer-token-app-only-auth">
  ## Bearer Token (autenticación de solo aplicación)
</div>

Para operaciones de solo lectura y para acceder a datos públicos:
...
Para operaciones específicas del usuario:
...
(async (): Promise<void> => {
  ...
  // Después de la autorización, el usuario es redirigido con un parámetro code
  // Extrae el valor de code de la URL de callback (por ejemplo, de los parámetros de consulta)
  const authCode: string = 'code-from-callback-url'; // Sustituye esto por el valor real de code del callback de OAuth
...
(async () => {
  ...
  // Después de la autorización, el usuario es redirigido con un parámetro code
  // Extrae el valor de code de la URL de callback (por ejemplo, de los parámetros de consulta)
  const authCode = 'code-from-callback-url'; // Sustituye esto por el valor real de code del callback de OAuth
...
Almacena credenciales confidenciales en variables de entorno:
