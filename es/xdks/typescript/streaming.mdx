...
El SDK de TypeScript proporciona funcionalidades de transmisión para flujos de datos en tiempo real.
...
<Info>
  Para ver ejemplos de código detallados con el XDK para JavaScript/TypeScript, consulta nuestro [repositorio de ejemplos de código en GitHub](https://github.com/xdevplatform/samples/tree/main/javascript).
</Info>
