...
para todas las operaciones relacionadas con publicaciones.
...
Obtiene insights de Publicaciones de las últimas 28 horas\
...
| Nombre | Tipo | Descripción |
| :------ | :------ | :------ |
| `tweetIds` | `any`[] | Lista de IDs de publicaciones para métricas de 28 horas. |
...
Recupera datos de analíticas para las publicaciones especificadas dentro de un intervalo de tiempo definido.
...
| Nombre | Tipo | Descripción |
| :------ | :------ | :------ |
| `ids` | `any`[] | Una lista de id de Publicaciones separada por comas. Se permiten hasta 100 en una sola solicitud. |
...
Obtiene una lista de Publicaciones que republican una Publicación específica por su id.
...
Recupera publicaciones de los últimos 7 días que coincidan con una consulta de búsqueda.
...
| Nombre | Tipo | Descripción |
| :------ | :------ | :------ |
| `query` | `string` | Una consulta/regla/filtro para buscar Publicaciones que coincidan. Consulta https://t.co/rulelength para ver la longitud máxima de la consulta. |
...
Obtener Publicaciones por identificadores
Recupera los detalles de varias Publicaciones por sus identificadores.
...
| Nombre | Tipo | Descripción |
| :------ | :------ | :------ |
| `ids` | `any`[] | Una lista de IDs de Publicación, separada por comas. Se permiten hasta 100 en una sola solicitud. |
...
Promise que se resuelve con la respuesta de la API o, si `requestOptions.raw` es `true`, con el objeto `Response` sin procesar
...
Obtiene el número de publicaciones de los últimos 7 días que coinciden con una consulta de búsqueda.
...
| Nombre | Tipo | Descripción |
| :------ | :------ | :------ |
| `query` | `string` | Una única consulta/regla/filtro para hacer coincidir Publicaciones. Consulta https://t.co/rulelength para conocer la longitud máxima de la consulta. |
...
Ocultar respuesta\
Oculta o vuelve a mostrar una respuesta dentro de una conversación que pertenece al usuario autenticado.
...
| Nombre | Tipo | Descripción |
| :------ | :------ | :------ |
| `tweetId` | `string` | El id de la respuesta que quieres ocultar o volver a mostrar. |
...
Obtiene información histórica sobre Publicaciones\
Obtiene métricas históricas de interacción para publicaciones especificadas dentro de un intervalo de tiempo definido.
...
Recupera el número de Publicaciones que coinciden con una consulta de búsqueda en el archivo completo.
...
| Nombre | Tipo | Descripción |
| :------ | :------ | :------ |
| `query` | `string` | Una consulta, regla o filtro para hacer coincidir publicaciones. Consulta https://t.co/rulelength para identificar la longitud máxima de la consulta. |
...
| Nombre | Tipo | Descripción |
| :------ | :------ | :------ |
| `id` | `string` | El id de la Publicación que se va a eliminar. |
| `options` | `Object` | - |
| `options.requestOptions` | `Object` | - |
| `options.requestOptions.raw` | `true` | - |
...
Obtener usuarios a los que les gustó la Publicación
