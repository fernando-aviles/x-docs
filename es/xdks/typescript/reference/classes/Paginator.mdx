...
Esta clase proporciona soporte completo de paginación para X API, incluida:
...
| Nombre | Descripción |
| :------ | :------ |
| `T` | Tipo de elementos que se paginan |
...
Este método obtiene la página siguiente de datos y agrega los elementos a la
...
sin afectar al estado del paginador actual.
...
Devuelve la página anterior como una nueva instancia
