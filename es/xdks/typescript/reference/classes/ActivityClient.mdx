...
Este cliente ofrece métodos para interactuar con los endpoints de actividad
...
Obtener suscripciones de actividad en X
...
Crear una suscripción a la actividad de X
...
Actualiza una suscripción a eventos de actividad de X
...
| Nombre | Tipo | Descripción |
| :------ | :------ | :------ |
| `subscriptionId` | `string` | El identificador de la suscripción que se va a eliminar. |
| `options` | `Object` | - |
| `options.requestOptions` | `Object` | - |
| `options.requestOptions.raw` | `true` | - |
