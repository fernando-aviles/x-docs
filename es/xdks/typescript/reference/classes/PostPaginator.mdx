...
• **new PostPaginator**(`fetchPage`): [`PostPaginator`](/es/xdks/typescript/reference/classes/PostPaginator)
...
Comprueba si se ha completado la paginación
...
Cuando falla la solicitud de la API
...
Este método crea una nueva instancia de paginador que empieza en la página siguiente,
