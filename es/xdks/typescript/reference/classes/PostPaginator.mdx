...
| :------ | :------ | :------ |
| `fetchPage` | (`token?`: `string`) =&gt; `Promise`&lt;[`PaginatedResponse`](/es/xdks/typescript/reference/interfaces/PaginatedResponse)&lt;`any`&gt;&gt; | Función que obtiene una página de datos dado un token de paginación |
...
Obtén la página siguiente como una nueva instancia
