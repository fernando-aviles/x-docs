...
para todas las operaciones relacionadas con noticias.
...
Buscar en News
Obtiene una lista de noticias de News que coinciden con la consulta de búsqueda especificada.
