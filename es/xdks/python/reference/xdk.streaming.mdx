...
Utilidades robustas de streaming para el SDK de X API.

Este módulo proporciona gestión de conexiones de streaming con reconexión automática,
reintentos con backoff exponencial y gestión de errores completa. Los clientes pueden consumir
endpoints de streaming sin tener que preocuparse por la gestión de la conexión; el SDK
se encarga automáticamente de toda la recuperación.
...
Excepción generada para errores de streaming con una clasificación asociada.
...
Esta función gestiona por completo la conexión, incluida:

- Reconexión automática ante desconexiones
- Backoff exponencial con jitter para los intervalos de reintento
