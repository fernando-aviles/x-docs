...
backoff exponencial y gestión integral de errores. Los clientes pueden consumir
endpoints de streaming sin preocuparse por la gestión de la conexión: el SDK
...
Configuración de las conexiones de streaming con lógica de reintento.
...
Excepción generada para errores de streaming con una clasificación.
...
Esta función gestiona toda la conexión, incluido:
