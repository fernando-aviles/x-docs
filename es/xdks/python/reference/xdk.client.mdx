...
Este módulo proporciona la clase Cliente principal para interactuar con X API.
...
La URL base para X API (por defecto [https://api.x.com](https://api.x.com)).
</ParamField>

<ParamField path="path.bearer_token" type="str or None" default="None">
El Bearer Token para X API (autenticación de solo aplicación).
</ParamField>
...
Cadena de texto separada por espacios o lista de cadenas de texto para los alcances de autorización OAuth2.
</ParamField>
