...
Cliente para la gestión de mensajes directos
...
Crear mensaje directo mediante ID de conversación
...
El id del usuario destinatario que recibirá el MD.
</ParamField>
...
Eliminar evento de DM
Elimina un evento de DM específico por su id, siempre que pertenezca al usuario autenticado.
...
Obtener evento de MD por identificador
Obtiene los detalles de un evento específico de Mensaje Directo a partir de su identificador.
...
<ParamField path="path.dm_event_fields" type="List or None" default="None">
Lista separada por comas de campos de DmEvent para mostrar.
</ParamField>
...
<ParamField path="path.media_fields" type="List or None" default="None">
Lista separada por comas de campos de Media para mostrar.
</ParamField>

<ParamField path="path.user_fields" type="List or None" default="None">
Lista separada por comas de campos de User para mostrar.
</ParamField>
