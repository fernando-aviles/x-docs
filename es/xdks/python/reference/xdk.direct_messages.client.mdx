...
Envía un nuevo mensaje directo a una conversación específica por su ID.
...
Devuelve los eventos de mensajes directos de una conversación específica.
