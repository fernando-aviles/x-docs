...
Buscar noticias
Obtiene una lista de noticias que coincidan con la consulta de búsqueda indicada.
...
<ParamField path="path.news_fields" type="List or None" default="None">
Una lista separada por comas de los campos de noticias que se mostrarán.
</ParamField>
