...
keywords: ["X API", "Twitter API", "개발자 플랫폼", "API 문서", "X 개발자", "API 키", "SDK", "Python SDK", "TypeScript SDK", "API 연동", "개발자 도구", "API 빠른 시작", "X Ads API", "X for Websites"]
---

import { Button } from '/snippets/ko/button.mdx';

<Card title="Python 및 TypeScript용 XDK: 지금 이용 가능합니다" icon="bolt" iconType="solid">
  <div
    style={{
position: 'relative',
minHeight: '90px'
...
X의 실시간 글로벌 데이터를 활용해 서비스를 구축·분석하고 혁신을 실현하세요. 유연한 사용량 기반 과금이 적용되는 최신 API를 통해 게시물, 사용자, 트렌드 등에 접근할 수 있습니다.
...
<CardGroup cols={3}>
  ...
  <Card title="API 참조 문서" icon="code" href="/ko/x-api/introduction">
    게시물, 사용자, 스페이스, DM, 리스트 등의 엔드포인트를 살펴보세요.
  </Card>
...
<CardGroup cols={3}>
  <Card title="X API" icon="square-x-twitter" href="/ko/x-api/introduction">
    게시물, 사용자, Spaces, DMs, 리스트, 트렌드, 미디어 등 다양한 리소스에 액세스하세요. X의 공개 대화를 검색하고 스트리밍하며 분석하세요.
  </Card>
