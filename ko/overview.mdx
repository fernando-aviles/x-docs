...
X의 실시간 글로벌 데이터를 활용해 서비스를 구축·분석하고 혁신을 실현하세요. 유연한 사용량 기반 과금이 적용되는 최신 API를 통해 포스트, 사용자, 트렌드 등에 접근할 수 있습니다.
...
<CardGroup cols={3}>
  <Card title="X API" icon="square-x-twitter" href="/ko/x-api/introduction">
    포스트, 사용자, Spaces, DMs, 리스트, 트렌드, 미디어 등 다양한 리소스에 액세스하세요. X의 공개 대화를 검색하고 스트리밍하며 분석하세요.
  </Card>
