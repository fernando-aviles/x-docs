...
아래 도구를 사용해 X for Websites를 시작해 보세요.
...
>
나만의 임베디드 트윗, 타임라인 또는 버튼을 만들어 보세요.
</Card>
<Card
...
>
트윗 임베드와 X Cards를 포함해 WordPress 사이트를 X에 최적화하는 공식 플러그인입니다.
</Card>
<Card
  title="twemoji"
  icon="x-twitter"
...
다음 도구들은 폭넓은 웹 개발자 커뮤니티에서 제공하고 유지 관리하는 것으로, 공식 리소스가 아닙니다. 이러한 기여를 해주신 커뮤니티 여러분께 감사드립니다!
...
<CardGroup cols={3}>
  ...
  제작자: [@abraham](https://x.com/abraham)
  </Card>
