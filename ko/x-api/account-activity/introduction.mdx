...
sidebarTitle: 소개
description: 웹훅을 통해 실시간 계정 활동을 수신합니다
...
Account Activity API는 실시간 계정 활동 이벤트를 웹훅 엔드포인트로 전달합니다. 사용자 계정을 구독하면 사용자가 포스트를 올리거나 DM을 받거나 팔로우될 때 등 활동 발생 시 알림을 받을 수 있습니다.
...
* **CRC 검증** — webhook의 진위 확인
* **Signature 헤더** — `x-twitter-webhooks-signature`
* **HTTPS 필수** — 모든 webhook URL은 HTTPS를 사용해야 합니다
