...
<Note>
  ...
  * 승인이 완료된 앱을 보유한 [개발자 계정](https://developer.x.com/en/portal/petition/essential/basic-info)
  * 앱의 Bearer Token(개발자 콘솔의 &quot;Keys and tokens&quot;에서 확인할 수 있음)
</Note>
...
<Steps>
  <Step title="포스트 id 찾기">
    각 포스트에는 고유한 id가 있습니다. 해당 포스트의 URL에서 확인할 수 있습니다:
  ...
  <Step title="추가 필드 요청하기">
    ...
    <CodeGroup dropdown>
      ...
      print(response.data)
      print(response.includes)  # 작성자 사용자 객체가 포함됩니다
      ```
      ...
      console.log(response.data);
      console.log(response.includes); // 작성자 사용자 객체가 포함됩니다
      ```
    </CodeGroup>
  ...
  <Step title="여러 개의 포스트 조회">
    한 번의 요청으로 최대 100개의 포스트를 조회할 수 있습니다:
