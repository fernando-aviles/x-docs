...
title: 게시물 조회
sidebarTitle: 소개
description: ID로 포스트를 가져와 세부 정보를 확인하고, 사용 가능 여부를 확인하며, 수정 이력을 검토합니다
keywords: ["포스트 조회", "Tweet 조회", "Tweet 가져오기", "ID별 Tweet", "ID별 포스트", "조회 엔드포인트", "Tweet 세부 정보", "포스트 세부 정보", "수정 이력"]
---
