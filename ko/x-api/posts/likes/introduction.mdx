...
title: 좋아요
sidebarTitle: 소개
description: 게시물에 좋아요를 추가하거나 취소하고, 좋아요 정보를 조회합니다
keywords: ["좋아요", "좋아요 조회", "좋아요한 Tweet", "좋아요한 사용자", "좋아요 가져오기", "좋아요 엔드포인트", "즐겨찾기"]
---

import { Button } from '/snippets/ko/button.mdx';

Likes 엔드포인트를 사용하면 게시물에 좋아요를 추가하거나 취소하고, 어떤 사용자가 특정 게시물을 좋아했는지 확인하며, 특정 사용자가 좋아한 게시물을 가져올 수 있습니다.
...
| GET | [`/2/users/:id/liked_tweets`](/ko/x-api/users/get-liked-posts) | 사용자가 좋아요한 게시물 조회 |
