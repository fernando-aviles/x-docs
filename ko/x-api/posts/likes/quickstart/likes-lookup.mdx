...
title: 좋아요 조회
sidebarTitle: 좋아요 조회
description: 게시물을 좋아요한 사용자와 사용자가 좋아요한 게시물 조회
...
<CodeGroup dropdown>
  ...
  # 페이지네이션을 사용해 사용자가 좋아한 게시물을 가져옵니다.
...
expansions 매개변수를 사용해 고정 게시물과 같은 관련 데이터를 가져오세요:
...
<CodeGroup dropdown>
  ...
  # 고정 게시물 expansion을 포함해 좋아요한 사용자 가져오기
  for page in client.posts.get_liking_users(
      "1354143047324299264",
      ...
      # 고정 게시물은 page.includes.tweets에 있습니다
  ```
