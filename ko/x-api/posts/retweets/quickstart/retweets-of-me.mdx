...
keywords: ["나의 리트윗", "나의 리포스트", "내 리트윗", "리트윗 빠른 시작", "리트윗 튜토리얼", "리트윗 가이드"]
---

import { Button } from '/snippets/ko/button.mdx';

이 가이드는 다른 사용자가 리포스트한 자신의 포스트를 조회하는 방법을 안내합니다.
...
Retweets of Me 엔드포인트는 다음과 같은 데에 도움이 됩니다:

* **참여 추적** — 어떤 포스트가 공유되고 있는지 확인할 수 있습니다
* **공감도 파악** — 어떤 콘텐츠가 오디언스에게 잘 반응을 얻는지 파악할 수 있습니다
