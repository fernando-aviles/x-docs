---
title: 내 게시물 리트윗
sidebarTitle: 내 게시물 리트윗
description: 리트윗된 내 게시물 가져오기
keywords: ["내 게시물 리트윗", "내 게시물 리게시물", "내 리트윗", "리트윗 빠른 시작", "리트윗 튜토리얼", "리트윗 가이드"]
---

import { Button } from '/snippets/ko/button.mdx';

이 가이드는 다른 사용자가 리트윗한 내 게시물을 조회하는 방법을 단계별로 설명합니다.
...
* **참여 추적** — 어떤 게시물이 공유되고 있는지 확인할 수 있습니다
...
| `end_time` | 가장 최근 게시물의 타임스탬프 (ISO 8601) | — |
...
<CardGroup cols={2}>
  ...
  <Card title="API 참조 문서" icon="code" href="/ko/x-api/posts/reposts-of-me">
    전체 엔드포인트 문서를 확인하세요
  </Card>
</CardGroup>