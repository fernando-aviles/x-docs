...
title: 퀵스타트
sidebarTitle: 퀵스타트
description: 포스트에 달린 답글을 숨기거나 다시 표시합니다
keywords: ["포스트 답글 숨기기 퀵스타트", "포스트 답글 숨기기 튜토리얼", "포스트 답글 관리 가이드"]
---

import { Button } from '/snippets/ko/button.mdx';

이 가이드는 당신이 시작한 대화에서 포스트에 대한 답글을 숨기고 다시 표시하는 방법을 안내합니다.
...
<Steps>
  <Step title="답글의 포스트 ID 찾기" icon="message">
    숨기려는 답글의 ID를 확인합니다. 인증된 사용자가 시작한 대화에 대한 답글만 숨길 수 있습니다.
  ...
  <Step title="답글이 숨겨졌는지 확인하기" icon="check">
    ...
    이제 해당 답글은 주요 대화 화면에서 숨겨졌습니다. 사용자는 &quot;숨겨진 답글 보기&quot;를 클릭하면 여전히 해당 답글을 볼 수 있습니다.
  </Step>
</Steps>
...
<Note>
  * **직접 시작한** 대화에 대한 답글만 숨길 수 있습니다
  * 숨겨진 답글은 여전히 &quot;숨김 답글 보기&quot;를 통해 확인할 수 있습니다
...
<CardGroup cols={2}>
  ...
  <Card title="실시간 관리" icon="bolt" href="/ko/x-api/posts/hide-replies/integrate/manage-replies-in-realtime">
    답글이 달리는 즉시 관리합니다
  </Card>
