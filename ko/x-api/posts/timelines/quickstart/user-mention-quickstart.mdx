...
title: 사용자 멘션 타임라인
sidebarTitle: 사용자 멘션
description: 특정 사용자가 언급된 포스트 가져오기
keywords: ["사용자 멘션", "멘션 타임라인", "멘션 빠른 시작", "멘션 튜토리얼", "멘션 타임라인", "멘션 가져오기"]
---

import { Button } from '/snippets/ko/button.mdx';

이 가이드는 특정 사용자가 언급된 포스트를 조회하는 방법을 단계별로 설명합니다.
...
<Note>
  ...
  * App의 Bearer Token(공개 data용) 또는 User Access Token(비공개 메트릭용)
</Note>
      ...
      "data": [
        {
          ...
          "text": "Hey @XDevelopers, 새로운 API가 정말 마음에 들어요!",
