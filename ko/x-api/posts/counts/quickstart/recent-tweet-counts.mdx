...
keywords: ["최근 트윗 수 퀵스타트", "최근 카운트 퀵스타트", "트윗 볼륨 퀵스타트", "카운트 퀵스타트", "최근 검색 카운트"]
---
...
<Steps>
  <Step title="쿼리 작성하기">
    최신 검색과 동일한 쿼리 구문을 사용합니다. 예를 들어, @XDevelopers 계정의 포스트 개수를 조회하려면 다음과 같이 입력합니다:
...
<CardGroup cols={2}>
  <Card title="전체 아카이브 집계" icon="vault" href="/ko/x-api/posts/counts/quickstart/full-archive-tweet-counts">
    과거 포스트 개수 확인하기
  </Card>
