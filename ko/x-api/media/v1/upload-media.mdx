...
Tweet, 다이렉트 메시지, 사용자 프로필 사진, 호스팅된 Ads 카드 등의 객체에는 하나 이상의 미디어 객체가 포함될 수 있습니다. 이러한 최상위 객체를 통칭해 엔티티라고 합니다. 관련 엔티티 생성 API(예: POST statuses/update)는 고유한 media_id를 사용해 하나 이상의 미디어 객체를 전달받을 수 있습니다.
