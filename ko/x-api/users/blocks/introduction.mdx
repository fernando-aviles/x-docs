...
title: 차단
sidebarTitle: 소개
description: 사용자를 차단하거나 차단을 해제하고, 차단된 사용자 목록을 조회합니다
keywords: ["차단", "사용자 차단", "차단 해제", "차단된 사용자", "차단 API"]
---

import { Button } from '/snippets/ko/button.mdx';

Blocks 엔드포인트를 사용하면 사용자를 차단하고 차단 해제하며, 인증된 사용자가 차단한 사용자 목록을 조회할 수 있습니다.
...
|:-------|:---------|:------------|
| GET | [`/2/users/:id/blocking`](/ko/x-api/users/get-blocking) | 차단한 사용자 조회 |
