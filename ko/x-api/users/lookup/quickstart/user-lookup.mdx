...
keywords: ["사용자 조회 빠른 시작", "사용자 가져오기 튜토리얼", "ID로 사용자 조회 가이드", "사용자 이름으로 사용자 조회"]
---

import { Button } from '/snippets/ko/button.mdx';

이 가이드는 사용자 id 또는 사용자 이름으로 사용자를 조회하는 방법을 설명합니다.
...
보호된 사용자의 data는 여전히 반환되지만, 해당 사용자를 팔로우하지 않는 이상 그 사용자의 포스트에는 접근할 수 없습니다.
