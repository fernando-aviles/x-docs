...
description: 현재 인증된 사용자의 프로필을 가져옵니다.
keywords: ["인증된 사용자", "me 엔드포인트", "현재 사용자", "인증 조회"]
---
...
<CodeGroup dropdown>
  ...
  print(f"Username: {response.data.username}")
  # 고정된 게시물은 response.includes.tweets에 있습니다.
  ```
...
<CardGroup cols={2}>
  ...
  <Card title="API 참조 문서" icon="code" href="/ko/x-api/users/authenticated-user-lookup">
    엔드포인트 전체 문서
  </Card>
</CardGroup>