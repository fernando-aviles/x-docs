...
title: 팔로우
sidebarTitle: 소개
description: 팔로우를 관리하고 팔로워/팔로잉 정보를 조회합니다
keywords: ["팔로우", "팔로워", "팔로잉", "팔로우 API", "언팔로우", "팔로워 조회"]
---

import { Button } from '/snippets/ko/button.mdx';

Follows 엔드포인트를 사용하면 사용자를 팔로우하거나 언팔로우하고, 임의의 사용자의 팔로워 및 팔로잉 목록을 조회할 수 있습니다.
...
|:-------|:---------|:------------|
| GET | [`/2/users/:id/followers`](/ko/x-api/users/get-followers) | 사용자의 팔로워 조회 |
| GET | [`/2/users/:id/following`](/ko/x-api/users/get-following) | 사용자가 팔로우하는 계정 조회 |
...
| Method | Endpoint | Description |
|:-------|:---------|:------------|
| POST | [`/2/users/:id/following`](/ko/x-api/users/follow-user) | 사용자를 팔로우 |
| DELETE | [`/2/users/:source_user_id/following/:target_user_id`](/ko/x-api/users/unfollow-user) | 사용자 팔로우 해제 |
