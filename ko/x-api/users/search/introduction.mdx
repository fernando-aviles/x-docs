...
title: 사용자 검색
sidebarTitle: 소개
description: 키워드로 사용자를 검색합니다
keywords: ["사용자 검색", "사용자 검색하기", "사용자 찾기", "사용자 검색 API", "인물 검색"]
---

import { Button } from '/snippets/ko/button.mdx';

User Search 엔드포인트를 사용하면 키워드로 사용자를 검색할 수 있습니다. 이름, 사용자 이름 또는 프로필 소개란에 포함된 콘텐츠를 기준으로 사용자를 찾을 수 있습니다.
