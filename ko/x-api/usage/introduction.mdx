...
Usage 엔드포인트는 소비된 게시물 수를 포함한 API 사용량을 모니터링할 수 있게 해줍니다. 사용량을 프로그램적으로 추적하여 비용을 관리하고 한도 내에서 사용량을 유지하세요.
...
<CardGroup cols={2}>
  <Card title="게시물 사용량" icon="chart-simple">
    소비된 게시물을 추적
  </Card>
...
| `tweets_consumed` | 해당 일자에 소모된 게시물 수 |
| `project_cap` | 월간 게시물 사용 한도 |
