...
<Steps>
  <Step title="리스트 ID와 사용자 ID 가져오기">
    리스트의 ID와 추가하려는 사용자의 ID가 필요합니다. [user lookup endpoint](/ko/x-api/users/lookup/introduction)를 사용해 사용자 ID를 조회할 수 있습니다.
  </Step>
...
<Note>
  * 자신이 소유하고 있는 리스트의 멤버만 관리할 수 있습니다
  * 사용자를 리스트에 추가할 때 그 사용자의 동의를 받을 필요는 없습니다
  * 사용자는 자신이 어떤 공개 리스트에 추가되었는지 확인할 수 있습니다
</Note>
