...
<Steps>
  <Step title="리스트 ID 찾기">
    리스트를 볼 때 해당 URL에서 리스트 ID를 확인할 수 있습니다:
...
expansions를 사용해 고정된 포스트와 같은 관련 데이터를 가져올 수 있습니다:
...
<CodeGroup dropdown>
  ...
  # expansions를 사용해 List 멤버를 가져옵니다
  for page in client.lists.get_members(
      "84839422",
