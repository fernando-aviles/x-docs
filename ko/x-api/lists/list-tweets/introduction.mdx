...
title: 리스트 게시물
sidebarTitle: 소개
description: 리스트 타임라인에서 게시물을 조회합니다
keywords: ["리스트 Tweet", "리스트 게시물", "리스트 타임라인", "리스트 피드", "리스트 게시물 API"]
---

import { Button } from '/snippets/ko/button.mdx';

List Posts 엔드포인트를 사용하면 리스트 타임라인에서 게시물을 조회할 수 있습니다. 리스트의 모든 멤버가 작성한 최신 게시물을 가져올 수 있습니다.
...
| 메서드 | 엔드포인트 | 설명 |
|:-------|:---------|:------------|
| GET | [`/2/lists/:id/tweets`](/ko/x-api/lists/get-list-posts) | 리스트에서 게시물을 가져옵니다 |
