...
title: 개요
sidebarTitle: 개요
keywords: ["리스트 마이그레이션", "리스트 관리 마이그레이션", "v1.1에서 v2로 리스트 마이그레이션", "리스트 마이그레이션 가이드", "리스트 마이그레이션"]
---
...
| 기본 요청 [rate limits](/ko/resources/fundamentals/rate-limits) | 없음 | 15분당 사용자당 300회 요청 |
