...
이 가이드에서는 리스트를 생성, 업데이트 및 삭제하는 방법을 단계별로 안내합니다.
...
<Steps>
  <Step title="요청 준비하기">
    리스트 이름(필수)과 선택 사항인 설명 및 비공개 설정을 지정합니다:
  ...
  <Step title="응답 검토하기">
    ...
    나중에 리스트를 업데이트하거나 삭제하려면 `id`를 저장해 두세요.
  </Step>
</Steps>
