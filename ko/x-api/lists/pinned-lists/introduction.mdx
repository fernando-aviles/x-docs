...
title: 고정된 리스트
sidebarTitle: 소개
description: 고정된 리스트를 확인하고 관리합니다
keywords: ["고정된 리스트", "리스트 고정", "리스트 고정 해제", "고정된 리스트 API"]
---

import { Button } from '/snippets/ko/button.mdx';

Pinned Lists 엔드포인트를 사용하면 인증된 사용자의 Lists를 조회하고, 고정하고, 고정을 해제할 수 있습니다. 고정된 Lists는 사용자의 X 인터페이스 내에서 눈에 잘 띄는 위치에 표시됩니다.
