...
<Steps>
  <Step title="사용자 ID 및 리스트 ID 가져오기">
    인증된 사용자 ID와 고정하려는 리스트 ID가 필요합니다. 리스트를 볼 때 URL에서 리스트 ID를 확인할 수 있습니다.
  </Step>
...
<Note>
  * 팔로우하거나 소유한 리스트만 고정할 수 있습니다
  * 고정된 리스트는 X 앱에서 내 리스트 맨 위에 표시됩니다
  * 고정할 수 있는 리스트 수에는 제한이 있습니다
</Note>
