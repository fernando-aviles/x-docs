...
TypeScript SDK는 실시간 데이터 피드 스트리밍 기능을 제공합니다.

<div id="basic-streaming">
  ## 기본 스트리밍
</div>

실시간 샘플 포스트 스트림에 연결합니다:
...
stream.on('data', (event) => {
  // event는 파싱된 JSON 라인(data/includes/matching_rules)입니다
