...
요청 한 번당 반환할 검색 결과의 최대 개수입니다.
</ParamField>

<ParamField path="path.next_token" type="Any or None" default="None">
다음 "페이지"의 결과를 가져오는 데 사용하는 매개변수입니다. 이 매개변수에 사용할 값은 API 응답에서 그대로 가져온 것이며, 수정해서는 안 됩니다.
</ParamField>
...
<ParamField path="path.community_fields" type="List or None" default="None">
표시할 Community 필드를 쉼표로 구분한 리스트입니다.
</ParamField>
