...
폴더 ID로 북마크 조회
인증된 사용자의 특정 북마크 폴더에서 해당 ID를 가진 게시물을 조회합니다.
...
인증된 사용자가 게시물을 가져오려는 북마크 폴더의 ID입니다.
</ParamField>
...
좋아요한 게시물 조회
특정 사용자의 id를 사용하여 해당 사용자가 좋아요한 게시물 목록을 조회합니다.
...
멘션 조회
특정 사용자의 ID를 기준으로 해당 사용자를 멘션한 게시물 목록을 반환합니다.
...
게시물 가져오기
특정 사용자의 id로 해당 사용자가 작성한 게시물 목록을 조회합니다.
...
<ParamField path="path.start_time" type="str or None" default="None">
YYYY-MM-DDTHH:mm:ssZ. 게시물이 반환될 가장 이른 UTC 타임스탬프입니다. since_id 매개변수가 함께 지정된 경우, since_id가 우선합니다.
</ParamField>

<ParamField path="path.end_time" type="str or None" default="None">
YYYY-MM-DDTHH:mm:ssZ. 게시물이 반환될 가장 늦은 UTC 타임스탬프입니다. until_id 매개변수가 함께 지정된 경우, until_id가 우선합니다.
</ParamField>
...
타임라인 가져오기
인증된 사용자의 타임라인에 있는 게시물 리스트를 최신순(시간 역순)으로 반환합니다.
...
<ParamField path="path.id" type="Any">
최신순 타임라인 게시물을 나열할 인증된 소스 User의 ID입니다.
</ParamField>
...
<ParamField path="path.start_time" type="str or None" default="None">
YYYY-MM-DDTHH:mm:ssZ. 게시물이 제공될 가장 이른 UTC 타임스탬프입니다. since_id 매개변수도 지정된 경우, since_id가 우선합니다.
</ParamField>

<ParamField path="path.end_time" type="str or None" default="None">
YYYY-MM-DDTHH:mm:ssZ. 게시물이 제공될 가장 늦은 UTC 타임스탬프입니다. until_id 매개변수도 지정된 경우, until_id가 우선합니다.
</ParamField>
...
게시물 리게시물
인증된 사용자가 지정한 게시물 ID에 해당하는 특정 게시물을 리게시물합니다.

#### 매개변수

<ParamField path="path.id" type="Any">
게시물 리게시물을 요청하는 인증된 소스 사용자 ID입니다.
</ParamField>
...
<ParamField path="path.id" type="Any">
게시물을 리게시물하도록 요청하는 인증된 소스 사용자의 ID입니다.
</ParamField>

<ParamField path="path.source_tweet_id" type="Any">
사용자가 리게시물 취소를 요청하는 게시물의 ID입니다.
</ParamField>
