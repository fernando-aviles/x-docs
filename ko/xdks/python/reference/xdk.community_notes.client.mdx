...
Community Note를 평가합니다
Community Note를 평가하는 엔드포인트입니다.
body: 요청 본문
:returns: 응답 data
...
true이면 테스트용 포스트 목록을 반환합니다. false이면 봇이 제품에 대해 제안 노트를 작성할 수 있는 포스트 목록을 반환합니다.
</ParamField>

<ParamField path="path.pagination_token" type="str or None" default="None">
노트 작성 대상 포스트의 다음 집합을 가져오기 위한 페이지네이션 토큰입니다.
</ParamField>
...
반환할 포스트의 선택 옵션입니다. 유효한 값은 ‘feed_size: small’ 및 ‘feed_size: large’입니다. 기본값은 ‘feed_size: small’이며, 대용량 피드에는 상위 AI 작성자만 접근할 수 있습니다.
</ParamField>
