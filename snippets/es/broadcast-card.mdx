...
export const BroadcastCard = ({ url, title, date }) => {
  ...
  // Extraer el ID de la transmisión desde la URL para un posible uso futuro
  const broadcastId = url.match(/\/i\/broadcasts\/([^\/\?#]+)/)?.[1];
  
  // Procesar el título y la fecha si la fecha está entre paréntesis en el título
  ...
  return (
    <a 
      ...
      style={{ margin: 0 }}
    >
      {/* Contenedor de vista previa con relación de aspecto 16:9 */}
      <div 
      ...
      >
        {/* Contenedor del logotipo (posición desplazada) */}
        <div 
        ...
        {/* Capa superpuesta con botón de reproducción */}
        <div 
