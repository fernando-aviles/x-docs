...
Le endpoint de recherche d’actualités permet aux développeurs d’obtenir les dernières actualités et titres publiés sur X.

Cet endpoint prend en charge l’authentification applicative (app-auth) et utilisateur (user-auth) pour OAuth1 et OAuth2 PKCE.

<div id="getting-started">
  ## Prise en main
</div>

Pour utiliser l&#39;endpoint, vous avez besoin d’un [bearer token](/fr/fundamentals/authentication/oauth-2-0/application-only) depuis la [Console de Développement](https://developer.x.com/en/portal/dashboard).
