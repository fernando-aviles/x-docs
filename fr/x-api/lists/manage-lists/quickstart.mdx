...
keywords: ["démarrage rapide gestion des listes", "tutoriel de création de liste", "guide de gestion des listes"]
---
...
<Steps>
  <Step title="Préparez votre requête">
  ...
  <Step title="Examinez la réponse">
    ...
    Enregistrez l’`id` pour pouvoir mettre à jour ou supprimer la Liste ultérieurement.
  </Step>
</Steps>
...
<Steps>
  <Step title="Récupérer l’ID de la Liste">
    Vous avez besoin de l’ID de la Liste à supprimer.
  </Step>
...
<CardGroup cols={2}>
  <Card title="Membres de Liste" icon="users" href="/fr/x-api/lists/list-members/introduction">
    Ajouter et supprimer des membres d’une Liste
  </Card>
