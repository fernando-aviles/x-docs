...
description: Configurez des abonnements au flux d'activité et recevez des événements
keywords: ["démarrage rapide flux d'activité", "tutoriel flux d'activité", "guide des abonnements"]
---
...
<AccordionGroup>
  <Accordion title="Lister les abonnements">
    Récupérez tous les abonnements actifs :
