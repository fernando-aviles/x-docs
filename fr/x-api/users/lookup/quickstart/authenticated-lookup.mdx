...
keywords: ["utilisateur authentifié", "endpoint me", "utilisateur actuel", "recherche utilisateur authentifié"]
---
...
<CodeGroup dropdown>
  ...
  # Récupérer l’utilisateur authentifié avec sa Publication épinglée
  response = client.users.get_me(
  ...
  print(f"Username: {response.data.username}")
  # La Publication épinglée est disponible dans response.includes.tweets
  ```
...
| `location` | Localisation renseignée par l&#39;utilisateur |
