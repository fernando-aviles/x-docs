...
description: Bloquer et débloquer des utilisateurs, et récupérer votre liste de blocages
keywords: ["démarrage rapide du blocage", "démarrage rapide du blocage d’utilisateurs", "tutoriel sur le blocage", "guide de blocage"]
---
...
<Steps>
  <Step title="Récupérer l'identifiant de votre utilisateur">
    Vous avez besoin de l&#39;identifiant de votre utilisateur authentifié pour récupérer votre liste de comptes bloqués. Vous pouvez l&#39;obtenir à partir de l&#39;endpoint `/2/users/me` ou utiliser l&#39;identifiant présent dans vos jetons.
  </Step>

  <Step title="Récupérer votre liste de comptes bloqués">
    <CodeGroup dropdown>
      ```bash cURL
...
<Steps>
  <Step title="Identifier l’utilisateur cible">
    Récupérez l’identifiant (id) de l’utilisateur du compte que vous souhaitez bloquer.
  </Step>
...
<CardGroup cols={2}>
  <Card title="Mises en sourdine" icon="volume-xmark" href="/fr/x-api/users/mutes/introduction">
    Mettez des comptes en sourdine plutôt que de les bloquer
  </Card>
