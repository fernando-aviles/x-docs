...
keywords: ["démarrage rapide abonnements", "démarrage rapide abonnés", "tutoriel abonnements", "guide sur les abonnements"]
---
...
<Note>
  ...
  * du Bearer Token de votre App (pour les lookups)
  * d’un User Access Token (pour gérer les abonnements)
</Note>
...
Obtenez la liste des utilisateurs qui suivent un utilisateur donné :
...
Ne plus suivre un utilisateur au nom de l’utilisateur authentifié :
