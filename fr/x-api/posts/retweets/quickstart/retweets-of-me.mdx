...
description: Obtenez les Publications que d’autres ont retweetées
keywords: ["retweets de mes publications", "reposts de mes publications", "mes retweets", "démarrage rapide sur les retweets", "tutoriel sur les retweets", "guide sur les retweets"]
---
...
L’endpoint Retweets of Me vous permet de :
...
* **Orienter votre stratégie** — Adapter votre stratégie de contenu en fonction des comportements de partage
...
Récupérer les Publications republiées pour une période donnée :
...
<CodeGroup dropdown>
  ...
  # Récupérer les Publications republiées sur une plage temporelle
  for page in client.posts.get_reposts_of_me(
