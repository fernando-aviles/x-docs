...
keywords: ["Tweets cités", "publications citées", "recherche de publications citées", "Tweets cités", "API des publications citées"]
---
...
|:-------|:---------|:------------|
| GET | [`/2/tweets/:id/quote_tweets`](/fr/x-api/posts/get-quoted-posts) | Récupérer les Publications citées pour une Publication |
...
<CardGroup cols={2}>
  <Card title="Démarrage rapide" icon="rocket" href="/fr/x-api/posts/quote-tweets/quickstart">
    Récupérer les Publications citant une Publication
  </Card>
