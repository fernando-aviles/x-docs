...
description: Obtenir les Publications qui mentionnent un utilisateur spécifique
keywords: ["mentions d’utilisateur", "fil des mentions", "Démarrage rapide des mentions", "tutoriel sur les mentions", "fil de mentions", "obtenir les mentions"]
---
...
<Steps>
  <Step title="Obtenir l’ID de l’utilisateur">
    Trouvez l’ID de l’utilisateur à l’aide du [point de terminaison de recherche d’utilisateurs](/fr/x-api/users/lookup/introduction). Par exemple, @XDevelopers a pour ID d’utilisateur `2244994945`.
  </Step>

  <Step title="Effectuer une requête pour la timeline des mentions">
    <CodeGroup dropdown>
      ```bash cURL
...
|:----------|:------------|:--------|
| `max_results` | Nombre de résultats par page (1-100) | 10 |
...
| `since_id` | Renvoyer les Publications après cet identifiant | — |
| `until_id` | Renvoyer les Publications avant cet identifiant | — |
