---
title: Démarrage rapide de la timeline d’accueil
sidebarTitle: Timeline d’accueil
description: Obtenir la timeline d’accueil d’un utilisateur par ordre chronologique inverse
keywords: ["timeline d’accueil", "ordre chronologique inverse", "démarrage rapide de la timeline d’accueil", "démarrage rapide de la timeline", "tutoriel sur la timeline d’accueil"]
---
...
<CodeGroup dropdown>
  ...
  # Récupérer le fil d’accueil avec pagination
...
<CodeGroup dropdown>
  ...
  # Récupérez le fil d’accueil avec champs et expansions
