...
keywords: ["outils", "bibliothèques", "SDK", "bibliothèques client", "outils X API", "outils pour développeurs", "bibliothèques de code"]
---

import { Button } from '/snippets/fr/button.mdx';

Accélérez vos développements avec les SDK officiels, les bibliothèques de la communauté et les outils de développement.
...
<CardGroup cols={2}>
  ...
  <Card title="SDK TypeScript" icon="js" href="/fr/xdks/typescript/overview">
    Typage statique complet et prise en charge de l’ESM. Fonctionne avec Node.js et les bundlers modernes.
  </Card>
</CardGroup>
...
| Outil | Description |
|:-----|:------------|
| [Postman Collection](https://app.getpostman.com/run-collection/9956214-784efcda-ed4c-4491-a4c0-a26470a67400) | Tests d’API interactifs pour tous les endpoints de l’API v2 |
| [OpenAPI Spec](https://api.x.com/2/openapi.json) | Spécification d’API lisible par machine |
| [twitter-text](https://github.com/twitter/twitter-text) | Analyser et valider le texte des publications, compter les caractères |
...
Ces bibliothèques maintenues par la communauté sont compatibles avec X API v2. Consultez la documentation de chaque bibliothèque pour connaître la couverture actuelle de l’API.
...
<Tabs>
  ...
  <Tab title="Go">
    ...
    | [twitter-stream](https://github.com/Fallenstedt/twitter-stream) | Wrapper pour flux filtré |
  </Tab>
...
<Note>
  Les bibliothèques communautaires ne sont pas maintenues par X. Consultez leurs dépôts pour connaître les modalités de support et leur état actuel.
</Note>
...
* [X API v2 Sample Code](https://github.com/xdevplatform/Twitter-API-v2-sample-code) — Exemples en Python, JavaScript, Ruby, et plus encore
* [X Developer GitHub](https://github.com/xdevplatform) — Dépôts et outils officiels
* [Glitch Examples](https://glitch.com/@twitter) — Applications interactives et réutilisables
* [Replit Examples](https://replit.com/@twitter) — Développement directement dans le navigateur
...
Si vous avez créé une bibliothèque pour X API, partagez-la avec la communauté :

1. Publiez un message dans le [forum Libraries &amp; SDKs](https://devcommunity.x.com/c/libraries-and-sdks/63)
2. Nous pourrions l’ajouter à cette page !
