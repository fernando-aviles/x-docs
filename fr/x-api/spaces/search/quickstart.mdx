...
keywords: ["démarrage rapide recherche Spaces", "tutoriel recherche Spaces", "guide pour trouver des Spaces"]
---
...
Recherchez des Spaces correspondant à un mot-clé :
...
Recherchez uniquement les Spaces en direct ou programmés :
...
<CodeGroup dropdown>
  ...
  # Rechercher uniquement les Spaces en direct
...
<CodeGroup dropdown>
  ...
  # Rechercher uniquement les Espaces programmés
...
<CodeGroup dropdown>
  ...
  # Rechercher avec les informations sur l’hôte
  response = client.spaces.search(
      query="AI",
...
| `max_results` | Résultats à retourner (1-100) |
