...
Crée une nouvelle instance du client Webhooks
...
| Nom | Type | Description |
| :------ | :------ | :------ |
| `webhookId` | `string` | L’ID du webhook à associer à votre ensemble de règles FilteredStream. |
| `options` | `Object` | - |
...
Promesse qui se résout en une réponse de l&#39;API, ou en l&#39;objet `Response` brut si `requestOptions.raw` est à `true`
...
Récupère les liens de flux\
Récupère une liste de liens de webhook associés à un jeu de règles de flux filtré.
...
Crée une tâche de relecture permettant de récupérer les événements des 24 dernières heures maximum pour tous les événements livrés ou dont la livraison au webhook a été tentée.
...
Promise résolue avec la Réponse de l&#39;API, ou avec la Réponse brute si requestOptions.raw vaut true
...
Récupérer la liste des configurations de webhook associées à une application cliente.
