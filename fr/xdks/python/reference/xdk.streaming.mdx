...
des points de terminaison de diffusion en continu sans se soucier de la gestion des connexions : le SDK
prend automatiquement en charge toutes les opérations de reprise.

<div id="class-xdkstreamingstreamconfig">
  ### `class xdk.streaming.StreamConfig`
</div>

Configuration des connexions de streaming avec gestion des tentatives de reconnexion.
...
Exception levée pour les erreurs de streaming avec une classification associée.
...
Diffuse des données en continu à partir d’un endpoint avec reconnexion automatique et backoff exponentiel.
Cette fonction gère l’ensemble de la gestion des connexions, y compris :

- Reconnexion automatique en cas de déconnexion
- Backoff exponentiel avec gigue pour les délais de nouvelle tentative
- Classification des erreurs comme réessayables ou fatales
...
L’URL complète à partir de laquelle lire le flux.
</ParamField>

<ParamField path="path.config" type="StreamConfig">
StreamConfig avec les paramètres de réessai et de rappel.
</ParamField>