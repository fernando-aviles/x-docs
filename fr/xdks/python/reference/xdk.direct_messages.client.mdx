...
Crée un message direct par id de participant
Envoie un nouveau message direct à un participant spécifique identifié par son id.
...
Initie une nouvelle conversation de messages directs avec les participants spécifiés.
...
Récupère une liste des événements récents de messages privés pour toutes les conversations.
...
Récupérer les événements de messages privés pour une conversation de messages privés
...
Récupérer un événement de message direct par id
Récupère les détails d'un événement de message direct spécifique à partir de son id.
...
<ParamField path="path.dm_event_fields" type="List or None" default="None">
Liste de champs DmEvent, séparés par des virgules, à afficher.
</ParamField>
...
Lister les événements de messages directs d'une conversation de messages directs
