...
TypeScript SDK अलग-अलग उपयोग परिदृश्यों के लिए कई प्रमाणीकरण विधियों का समर्थन करता है।

<div id="bearer-token-app-only-auth">
  ## बेयरर टोकन (ऐप-ओनली प्रमाणीकरण)
</div>

रीड-ओनली ऑपरेशन और सार्वजनिक डेटा एक्सेस के लिए:
...
लीगेसी ऐप्स या विशिष्ट उपयोग मामलों के लिए:
...
उपयोगकर्ता-विशिष्ट ऑपरेशन के लिए:
...
<CodeGroup dropdown>
  ...
  (async () => {
    ...
    // अधिकृत करने के बाद, उपयोगकर्ता code पैरामीटर के साथ वापस रीडायरेक्ट हो जाता है
    // callback URL से code निकालें (उदाहरण के लिए, query params से)
    const authCode = 'code-from-callback-url'; // इसे OAuth callback से मिले वास्तविक code से बदलें
...
संवेदनशील क्रेडेंशियल को पर्यावरण चरों में संग्रहीत करें:
