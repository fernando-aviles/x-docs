...
>
用于针对 X 优化 WordPress 站点的官方插件，支持推文嵌入和 X 卡片。
</Card>
<Card
  title="twemoji"
  icon="x-twitter"
...
>
X 提供的免费开源表情符号字符集，并包含用于跨平台支持的 JavaScript 库。
</Card>
</CardGroup>
...
以下工具由更广泛的 Web 开发者社区提供和支持，并非官方资源。感谢社区的这些贡献！
...
由 [@MichaelDeBoey](https://github.com/MichaelDeBoey) 提供
</Card>
</CardGroup>
