...
title: 工具和库
mode: wide
keywords: ["X for Websites 工具", "嵌入式工具", "网站工具", "嵌入式库", "网站集成工具", "嵌入 SDK"]
---
...
>
一款官方插件，可针对 X 优化你的 WordPress 站点，包括推文嵌入和 X 卡片。
</Card>
<Card
  title="twemoji"
  icon="x-twitter"
...
>
X 的免费、开源表情符号字符集，并提供用于跨平台支持的 JavaScript 库。
</Card>
</CardGroup>
...
以下工具由更广泛的 Web 开发者社区提供和支持，并非官方资源。感谢社区为此做出的贡献！
...
<CardGroup cols={3}>
  ...
  由 [@jsternberg](https://github.com/jtsternberg) 提供
  </Card>
</CardGroup>