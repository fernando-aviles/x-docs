...
>
为你的 WordPress 站点优化 X 使用体验的官方插件，包括推文嵌入和 X 卡片。
</Card>
<Card
  title="twemoji"
  icon="x-twitter"
...
>
X 提供的免费开源 emoji 字符集，并附带用于跨平台支持的 JavaScript 库。
</Card>
</CardGroup>
...
以下工具由更广泛的 Web 开发者社区提供和维护，并非官方资源。我们感谢社区的这些贡献！
...
<CardGroup cols={3}>
  ...
  由 [@abraham](https://x.com/abraham) 开发
  </Card>
