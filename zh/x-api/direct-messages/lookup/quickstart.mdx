...
<CodeGroup dropdown>
  ...
  for await (const page of paginator) {
    ...
    // 发送者的用户对象位于 page.includes.users 中
  }
  ```
</CodeGroup>
...
| 参数 | 描述 |
|:----------|:------------|
| `max_results` | 每页事件数量（1-100，默认 100） |
| `pagination_token` | 下一页令牌 |
