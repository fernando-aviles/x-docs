...
title: 转推查询
sidebarTitle: 转推查询
description: 获取转推某条帖子的用户
keywords: ["转推查询", "转推快速入门", "获取转推用户", "转推教程", "转推指南", "转推示例"]
---

import { Button } from '/snippets/zh/button.mdx';

本指南将引导你获取转发了特定帖子（Post）的用户。
...
<Note>
  ...
  * 你的 App 的 Bearer Token（用于公开数据）或 User Access Token（用于私有指标）
</Note>
...
<CardGroup cols={2}>
  <Card title="管理转推" icon="retweet" href="/zh/x-api/posts/retweets/quickstart/manage-retweets">
    转推和撤销转推
  </Card>
