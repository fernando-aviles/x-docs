...
keywords: ["转推查询", "转推快速入门", "获取转推", "转推教程", "转推指南", "转推示例"]
---

import { Button } from '/snippets/zh/button.mdx';

本指南将引导你检索转发（Retweet）了特定帖子的用户。
