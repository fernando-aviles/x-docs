...
title: 管理点赞
sidebarTitle: 管理点赞
description: 使用 X API 为帖子点赞或取消点赞
keywords: ["管理点赞", "点赞帖子", "取消点赞", "点赞快速入门", "点赞教程", "点赞指南"]
---

import { Button } from '/snippets/zh/button.mdx';

本指南将指导你如何使用 X API 为帖子点赞和取消点赞。
...
<Note>
  ...
  * 一个[开发者账号](https://developer.x.com/en/portal/petition/essential/basic-info)，其中包含已获批准的 App
...
<Steps>
  <Step title="获取你的用户 ID">
    你需要经过认证的用户 ID。可以通过 [用户查找端点](/zh/x-api/users/lookup/introduction) 查找，或者从 Access Token 中获取（其中的数字部分就是你的用户 ID）。
  </Step>
