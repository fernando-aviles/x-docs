...
title: 点赞查询
sidebarTitle: 点赞查询
description: 获取对某条帖子点赞的用户，以及某用户点赞过的帖子
...
<Note>
  ...
  * 一个已创建并通过审批应用的[开发者账号](https://developer.x.com/en/portal/petition/essential/basic-info)
  * 应用的 Bearer Token（用于公开数据）或用户访问令牌（User Access Token，用于私有指标）
</Note>
