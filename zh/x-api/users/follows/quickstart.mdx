...
<Note>
  如果目标账号受保护，则在关注请求获批准前，`pending_follow` 会为 `true`。
</Note>
...
| 参数 | 说明 |
|:----------|:------------|
| `max_results` | 每页返回的结果数量（1-1000，默认 100） |
...
<CardGroup cols={2}>
  ...
  <Card title="封锁" icon="ban" href="/zh/x-api/users/blocks/introduction">
    封锁和解封用户
  </Card>
