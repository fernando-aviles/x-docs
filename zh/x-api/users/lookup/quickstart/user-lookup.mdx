...
title: 用户查询快速入门
sidebarTitle: 用户查询
description: 通过 ID 或用户名查询用户
keywords: ["用户查询快速入门", "获取用户教程", "按 ID 获取用户指南", "按用户名获取用户指南"]
---

import { Button } from '/snippets/zh/button.mdx';

本指南将指导你通过用户的 ID 或用户名来查找用户。
...
<Note>
  ...
  * 一个已获批准的应用（App）的[开发者账号](https://developer.x.com/en/portal/petition/essential/basic-info)
...
受保护用户的 data 仍会返回，但除非你关注了他们，否则无法访问他们的帖子。
