...
<Note>
  ...
  * 一个拥有已审核 App 的[开发者账号](https://developer.x.com/en/portal/petition/essential/basic-info)
...
<Steps>
  <Step title="获取你的用户 ID">
    你需要已认证用户的 ID。你可以使用 [user lookup endpoint](/zh/x-api/users/lookup/introduction) 获取，或者从你的 Access Token 中找到（其中的数字部分就是你的用户 ID）。
  </Step>
