...
<Note>
  ...
  * 一个[开发者账号](https://developer.x.com/en/portal/petition/essential/basic-info)（其中至少有一个已获批准的 App）
...
<Steps>
  <Step title="获取你的用户 ID">
    你需要你已认证用户的 ID。你可以通过 [用户查找端点](/zh/x-api/users/lookup/introduction) 获取，或者从 Access Token 中读取（其中的数字部分就是你的用户 ID）。
  </Step>
