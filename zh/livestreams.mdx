...
mode: wide
icon: video
keywords: ["直播活动", "视频教程", "开发者视频", "网络研讨会", "直播节目", "回放", "开发者学习资源"]
---

import { BroadcastCarousel } from '/snippets/zh/broadcast-carousel.mdx';

查看往期关于 X Developer Platform 的直播录制和回放，这些内容旨在帮助开发者社区学习并使用我们的工具进行构建。
...
<BroadcastCarousel broadcasts={[
  ...
  },
  {
    ...
    title: '上手 X API v2 中全新的 Media Upload 端点',
    date: '2025 年 3 月 5 日'
  },
  {
    url: 'https://x.com/i/broadcasts/1BRJjPqnBqaKw',
    title: '将开发者 App 迁移到 X API 2',
